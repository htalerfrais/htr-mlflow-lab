...
class RIMESLineImporter(DataImporter):
    """Import RIMES line-level samples from Hugging Face (French handwriting dataset)."""

    def __init__(self, dataset_name: str = "Teklia/RIMES-2011-line", config_name: str = "default") -> None:
    ...
    def import_data(self, split: str = "validation") -> Tuple[List[Sample], DatasetInfo]:
        try:
            ...
            raise Exception(f"Failed to import RIMES dataset: {exc}") from exc
